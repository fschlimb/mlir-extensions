...
func.func @test_insert_slice(%arg0: tensor<?xi64>, %arg1: tensor<?xi64>) -> tensor<?xi64> {
    %c0 = arith.constant 0 : index
    %c3 = arith.constant 3 : index
    %res = ndarray.insert_slice %arg1 into %arg0[%c0] [%c3] [%c3] : tensor<?xi64> into tensor<?xi64>
    return %res : tensor<?xi64>
}
...
func.func @test_insert_slice_cast(%arg0: tensor<5xi64>, %arg1: tensor<3xi64>) -> tensor<?xi64> {
    %c0 = arith.constant 0 : index
    %c3 = arith.constant 3 : index
    %1 = tensor.cast %arg0 : tensor<5xi64> to tensor<?xi64>
    %2 = tensor.cast %arg1 : tensor<3xi64> to tensor<?xi64>
    %res = ndarray.insert_slice %2 into %1[%c0] [%c3] [%c3] : tensor<?xi64> into tensor<?xi64>
    return %res : tensor<?xi64>
}
